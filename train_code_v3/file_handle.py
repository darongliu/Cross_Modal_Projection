...
def parse_args(parser):
    ...
    parser.add_argument('--train_default' , nargs=2, action="store", metavar="FILE", help='training default data/label!')
...
#    parser.add_argument('--minibatch-size', action="store", dest='minibatch_size', help='minibatch size for training, default: 100', type=int, default=100)
    ...
    parser.add_argument('--save-default', action="store", dest="save_default", default=None, metavar="FILE",help="Save RNN to file")
    parser.add_argument('--load-net', action="store", dest="load_net", default=None, metavar="FILE", help="Load RNN from file")
    parser.add_argument('--load-default', action="store", dest="load_default", default=None, metavar="FILE", help="Load RNN from file")
...
def negative_generator_default(triplet , all_info , word_vector) :
    all_entity   = all_info[0]
    all_relation = all_info[1]
    idx2name     = all_info[2]
    name2idx     = all_info[3]
