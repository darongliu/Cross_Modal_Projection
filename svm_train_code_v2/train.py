...
#    test_score     = F.rank_score
    ...
    for idx in range(len(test_label)) :
        ...
        rank_left = F.one_rank(label_info[0],left_p_val[idx],answer[0])
        rank_relation = F.one_rank(label_info[1],relation_p_val[idx],answer[1])
        rank_right = F.one_rank(label_info[2],right_p_val[idx],answer[2])
        total_rank = rank_left*rank_relation*rank_right
